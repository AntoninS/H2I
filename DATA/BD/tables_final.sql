...
--
-- Client :  localhost
-- Généré le :  Lun 09 Janvier 2017 à 08:53
...
INSERT INTO `module` (`moduleID`, `nomModule`, `semestre`, `Coefficient`, `tuteur`, `nbEpingle`) VALUES
(3, 'Probabilités et Statistiques', 3, 2.5, NULL, 0),
(4, 'Communication ', 1, 0, NULL, 1),
(5, 'Programmation C', 1, 0, 3, 0),
(6, 'Programmation Java', 2, 0, NULL, 0),
(7, 'Communication', 2, 0, NULL, 0),
(8, 'Communication', 3, 1.5, NULL, 0),
(9, 'Communication', 4, 0, NULL, 0),
(10, 'BDA', 3, 1.5, 3, 0),
(11, 'Algo avancé', 4, 0, NULL, 0),
(12, 'SE cours ', 3, 1.5, NULL, 0),
(13, 'SE TP', 3, 1, NULL, 0),
(14, 'Réseau', 3, 1.5, NULL, 0),
(15, 'Algo avancée', 3, 1.5, NULL, 0),
(16, 'PHP', 3, 1.5, NULL, 0),
(17, 'CPOA', 3, 2.5, NULL, 0),
(18, 'Modélisation mathématiques', 3, 1.5, NULL, 0),
(19, 'TIC Droit', 3, 1.5, NULL, 0),
(20, 'GSI 1', 3, 1.3, NULL, 0),
(21, 'GSI 2', 3, 1.2, NULL, 0),
(22, 'Anglais', 0, 2.5, NULL, 3);
