<?php
		...
		{
			$req1 = $this->executerRequete('DELETE FROM statistiques WHERE userID = ?', array($id));
			$req2 = $this->executerRequete('DELETE FROM utilisateurs WHERE utilisateurID = ?', array($id));
		}
	}
