<?php
		...
		echo '<a href="index.php?page=forum&action=epingler&id='.$sujet['sujetID'].'" class="buttonEpingle">Epingler le sujet</a>
		<table id="reponses">';
			foreach($messages as $ligne)
			{
				echo '<tr>
					...
					<td id="rep">
						<p class="date">'.$ligne['date'].'</p>
						<p>'.$ligne['contenu'].'</p>';
						if($ligne['premierMessage']==False){
							echo '<p><a href="index.php?page=forum&action=supprmessage&idm='.$ligne['messageID'].'" id="delete">Supprimer</a></p>
							<p><a href="index.php?page=forum&action=fermer&idm='.$ligne['messageID'].'" id="delete">Valider</a></p>';
						}
						else{
							echo '
							<p><a href="index.php?page=forum&action=supprmessage&idm='.$ligne['messageID'].'" id="delete">Supprimer</a></p>';
						}
					echo '</td>
				</tr>';
			}
		...
		<form method="post" action="index.php?page=forum&action=ajout_message">
