<header id="header" >
		...
		<div class="bh1" > <a href="index.php?action=deconnexion"> Se déconnecter </a> </div>
		<div class="bh2"> <a href=""> <img class="account"  alt="account" src="media/images/account.png" />  <p>Bienvenue  <?php echo $prenom['prenom'];  ?> ! </p> <img class="flecheMonCompte"  alt="account" src="media/images/fleche.png" />   </a> </div>
...
<nav id="sousheader" class="fixed">
			...
			<a class="bsh1" href="index.php?page=cours">Cours</a>
			<a class="bsh2" href="index.php?page=forum">Forum</a>
			<a class="bsh3" href="index.php?page=tutorats">Tutorats</a>
